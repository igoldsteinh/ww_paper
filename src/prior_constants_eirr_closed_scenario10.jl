...
# scenario 10, misspecify E and I, and R1 to be centered at 1.33% of true values
const gamma_sd = 0.2
...
const I_init_mean = 489 * (4/3)
const R1_init_sd = 0.05
const R1_init_mean = 2075 * (4/3)
const E_init_sd = 0.05
const E_init_mean = 225 * (4/3)
